...
In my donor dashboard at the top of the page, why am I seeing large  svgs, some stupid titles, Missing svgs for the Home and Profile pages in the header section. In the My profile page the Reward progress has a donnations badge written in a very ugly manner, in red boxed. he nearby requests container is very ugly, no distinct separator, and the hospital profiles are not clickable. What type of nonesense is this? Also  elements in the dashboard  page be moved to their specific pages as you have done for the hospital dashboard

------------------
In my donor dashboard at the top of the page, why am I seeing large  svgs, some stupid titles, Missing svgs for the Home and Profile pages in the header section. In the My profile page the Reward progress has a donnations badge written in a very ugly manner, in red boxed. he nearby requests container is very ugly, no distinct separator, and the hospital profiles are not clickable. What type of nonesense is this? Also  elements in the dashboard  page be moved to their specific pages as you have done for the hospital dashboard. Same applies to the blood bank page, I see large distorted icons at the begining of the dashboard page, fix that mess. I aslo realised te same menu nonesense has been done in the hospital dashboard, fix that nonesense as well. See how menus in my othe app were done cleanly; C:\Users\adm.vscode\Products\Freelancing, borrow some ideas from this instead of implementing nonesense. The menus should be in text and with proper svgs, not buttons or anything else.
----------------


ou are very stupid. In the hoispital dashboard first of all I told you the # National Blood Bank Inventory be moved from the dashboard with all it's content, UI and functionality to the inventory page, but you did not move it, you just maintained the nonesense that was on the inventory page already, the same for the forecast page, i cannopt find the other functionalities as they were in the dashboard. What nonesense is this?
---------------
